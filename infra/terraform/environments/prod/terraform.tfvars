...
# OAuth redirect URIs
# -------------------------------------------------------
jira_redirect_uri   = "https://PROD_API_GATEWAY_ID.execute-api.ap-south-1.amazonaws.com/api/v1/integrations/jira/callback"
google_redirect_uri = "https://PROD_API_GATEWAY_ID.execute-api.ap-south-1.amazonaws.com/api/v1/integrations/google/callback"
