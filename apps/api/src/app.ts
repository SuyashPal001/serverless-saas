...
import { tenderAuthoringRoutes } from './routes/tenderAuthoring';
import { tenderPrebidRoutes } from './routes/tenderPrebid';
import { tenderExtractRoutes } from './routes/tenderExtract';
import { tenderScoringRoutes } from './routes/tenderScoring';
import { tenderDocumentCheckRoutes } from './routes/tenderDocumentCheck';
import { tenderProposalRoutes } from './routes/tenderProposal';
import { tenderContractRoutes } from './routes/tenderContract';
import { tenderApprovalRoutes } from './routes/tenderApproval';
...
api.route('/tender', tenderRoutes);
api.route('/tender', tenderAuthoringRoutes);
api.route('/tender', tenderPrebidRoutes);
api.route('/tender', tenderExtractRoutes);
api.route('/tender', tenderScoringRoutes);
api.route('/tender', tenderDocumentCheckRoutes);
api.route('/tender', tenderProposalRoutes);
api.route('/tender', tenderContractRoutes);
api.route('/tender', tenderApprovalRoutes);
